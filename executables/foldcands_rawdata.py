...
'''
To do so, first fold accelsearch candidates on the dedispersed time series. Move a selection of .png files to a separate folder.
These selected candidates are then folded on the raw data.
'''
...
##############################################################
def main():
    """ Command line tool for folding prepfold candidates on raw data. """
    parser = ArgumentParser(description="Fold periodicity candidates on raw data..")
